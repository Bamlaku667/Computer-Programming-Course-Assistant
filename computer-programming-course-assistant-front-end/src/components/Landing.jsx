  ...
  return (
    <div className='grid grid-cols-2 items-center h-[87vh] px-8'>
        <div className='flex flex-col gap-10'>
            ...
            <p className='text-black text-4xl font-bold'>Access to online courses and labs with greate assistance</p>
            <div className='relative w-96'>
                <input type="text" className='block w-full shadow-md py-2 px-4 rounded-md focus:outline-none' placeholder='What do you want to learn?'/>
