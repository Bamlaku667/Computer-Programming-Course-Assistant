...
const StudentRegister = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (registerError.length > 0) {
        throw new errors_1.UnauthorizedError('please provide correct username, email and password');
    }
    const { userName, email, password } = newStudentInstance;
    const student = yield Student_1.Student.findOne({ email: email });
    if (student) {
        throw new errors_1.BadRequestError('Duplicate email please try again with a different email');
    }
    // hash the password 
...
const StudentLogin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (loginError.length > 0) {
        throw new errors_1.BadRequestError('please provide correct userName and Password');
    }
